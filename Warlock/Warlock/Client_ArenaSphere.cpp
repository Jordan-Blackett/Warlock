...
Client_ArenaSphere::Client_ArenaSphere()
{
}
...
void Client_ArenaSphere::init(b2World * world, sf::Vector2i position, float radius)
{
	scale_ = 32;
...
void Client_ArenaSphere::Render(sf::RenderWindow & Window)
{
	Window.draw(convex_);
}

std::vector<b2Vec2> Client_ArenaSphere::CreateCircle(int sides, float radius, sf::Vector2i offsetPosition)
{
...
void Client_ArenaSphere::CreateConvex(b2Vec2 * vertices, int points)
{
